        ...
        if customstrmsg is not None:
            ...
            start_msg = f"**⌔︙ اهلا وسهلا اخوي  {mention} **\
                        ...
                        \n**⌔︙ يمكنك التواصل مع صاحب البوت فقط ارسل رسالتك 👤.**\
                         \n\n**⌔︙ البوت خاص بسورس :** [AL WALI BOSS KZR](https://t.me/OIPU1)"
        buttons = [
            (
Button.url("تنصيب سورسنا", "https://dashboard.heroku.com/new?template=https://github.com/WALEUSERBOT/WALEUSERHELP"),
                Button.url(
                    "قناه المساعد",
                    "https://t.me/RXOXX",
                ),
